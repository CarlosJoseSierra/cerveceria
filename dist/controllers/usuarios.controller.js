...
exports.updateUserById = exports.getVendedores = exports.getUsuarios = exports.getUserById = exports.getUser = exports.getByUserPass = exports.getByInfo = exports.createNewUser = void 0;
...
var getVendedores = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          pool = _context2.sent;
          _context2.next = 6;
          return pool.request().query(_database.querys.getVendedores);
        case 6:
  ...
  return function getVendedores(_x3, _x4) {
...
var getByUserPass = /*#__PURE__*/function () {
      ...
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 23:
          ...
          return _context4.abrupt("return", res.status(500).json({
            status: "500",
            msg: res.send(_context4.t0.message),
            token: 0
          }));
        case 28:
        case "end":
  ...
  return function getByUserPass(_x7, _x8) {
...
var getByInfo = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        case 0:
          ...
          _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
            ...
            return _regeneratorRuntime().wrap(function _callee8$(_context8) {
              while (1) switch (_context8.prev = _context8.next) {
                ...
                case 2:
                  _context8.next = 4;
                  return _context8.sent.newPage();
                case 4:
                  page = _context8.sent;
                  _context8.next = 7;
                  return page.setUserAgent('5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36');
                case 7:
                  _context8.next = 9;
                  return page["goto"]('https://srienlinea.sri.gob.ec/sri-en-linea/SriDeclaracionesWeb/ConsultaImpuestoRenta/Consultas/consultaImpuestoRenta');
                case 9:
                  _context8.next = 11;
                  return page.waitForSelector(".ui-button");
                case 11:
                  _context8.next = 13;
                  return page.type("#busquedaRucId", body_filtros.documento);
                case 13:
                  _context8.next = 15;
                  return page.waitForTimeout(3000);
                case 15:
                  _context8.next = 17;
                  return page.waitForSelector("#g-recaptcha-response");
                case 17:
                  captha = body_filtros.captcha;
                  _context8.next = 20;
                  return page.evaluate("document.getElementById(\"g-recaptcha-response\").innerHTML=\"".concat(captha, "\";"));
                case 20:
                  _context8.next = 22;
                ...
                case 34:
                  tabla = _context8.sent;
                  //console.log(tabla);
                  arreglo = [salida.identificacion, salida.nombre, tabla[0], tabla[1], tabla[2], tabla[3], tabla[4], tabla[5], tabla[6], tabla[7], tabla[8], tabla[9], tabla[10], tabla[11], tabla[12], tabla[13], tabla[14], tabla[15], tabla[16], tabla[17], tabla[18], tabla[19]];
                  json = {};
                  arreglo.forEach(function (value, index) {
                    return json['elemento' + index] = value;
                  });
                  res.send(json);
                case 39:
                case "end":
          ...
          })["finally"]( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9() {
  ...
  return function getByInfo(_x15, _x16) {
    return _ref8.apply(this, arguments);
  };
}();
exports.getByInfo = getByInfo;