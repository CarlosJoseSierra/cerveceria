export const querys = {
  ...
  addNewUser:
    ...
    getAllVendedor:"SELECT VEND_id, VEND_nombres FROM VENDEDOR",
    ...
    getAllSubCanal:"SELECT SUBCAN_id, SUBCAN_descripcion FROM SUBCANAL",
    ...
    getAllSupervisor:"SELECT SUP_id, SUP_descripcion FROM SUPERVISOR",
    getSupervisorById: "SELECT SUP_id, SUP_descripcion FROM SUPERVISOR WHERE SUP_id = @id",
    getAllSubSegmentacion:"SELECT SUBSEG_id, SUBSEG_descripcion FROM SUBSEGMENTACION",
