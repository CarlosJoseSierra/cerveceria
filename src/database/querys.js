export const querys = {
  ...
  getAllActivos: "SELECT EQC_id,EQC_serie,EQC_placa,EQC_EQUIP_id,EQC_MARCA_id,EQC_MAP_ciudad,EQC_MAP_provincia,EQC_MAP_address,EQC_USU_ing,EQC_fecha_ing,EQC_codTag,EQC_LOGO_id,EQC_nombreCliente,EQC_identificacionCliente,EQC_direccionCliente,EQC_NegocioCliente,EQC_telefonoCliente,EQC_cambio,EQC_estadoEquipo,EQC_observacion,EQC_TI_id,EQC_UBIC_id,EQC_provincia,EQC_cabezales,EQUIP_modelo,MARCA_descripcion, EQUIP_descripcion,LOGO_nombre,USU_nombre FROM EQUIPO_COMPLETO AS E INNER  JOIN EQUIPO ON EQC_EQUIP_id = EQUIP_id INNER JOIN LOGO ON EQC_LOGO_id = LOGO_id INNER JOIN MARCA ON EQC_MARCA_id = MARCA_id INNER JOIN USUARIOS ON EQC_USU_ing = USU_id",
  getCountAllActive: "SELECT count(*) CONTEOEQUIPO FROM EQUIPO_COMPLETO",
  getActivoByUsuario: "SELECT EQC_id,EQC_serie,EQC_placa,EQC_EQUIP_id,EQC_MARCA_id,EQC_MAP_ciudad,EQC_MAP_provincia,EQC_MAP_address,EQC_USU_ing,EQC_fecha_ing,EQC_codTag,EQC_LOGO_id,EQC_nombreCliente,EQC_identificacionCliente,EQC_direccionCliente,EQC_NegocioCliente,EQC_telefonoCliente,EQC_cambio,EQC_estadoEquipo,EQC_observacion,EQC_TI_id,EQC_UBIC_id,EQC_provincia,EQC_cabezales,EQUIP_modelo,MARCA_descripcion, EQUIP_descripcion,LOGO_nombre,USU_nombre FROM EQUIPO_COMPLETO AS E INNER  JOIN EQUIPO ON EQC_EQUIP_id = EQUIP_id INNER JOIN LOGO ON EQC_LOGO_id = LOGO_id INNER JOIN MARCA ON EQC_MARCA_id = MARCA_id INNER JOIN USUARIOS ON EQC_USU_ing = USU_id WHERE EQC_USU_ing = @idUsuario",  
  getActivoById: "SELECT * FROM EQUIPO_COMPLETO Where EQC_id = @Id",
  getActivoByTag: "SELECT EQC_id,EQC_serie,EQC_placa,EQC_EQUIP_id,EQC_MARCA_id,EQUIP_modelo,EQUIP_descripcion,EQUIP_compresor,EQUIP_puertas,EQC_MAP_ciudad,EQC_MAP_provincia,EQC_MAP_address,EQC_fecha_ing,EQC_codTag,EQC_LOGO_id, LOGO_nombre,EQC_nombreCliente,EQC_identificacionCliente,EQC_NegocioCliente,EQC_telefonoCliente,EQC_direccionCliente,EQC_estadoEquipo,EQC_TI_id,MARCA_descripcion,EQC_observacion FROM EQUIPO_COMPLETO AS E INNER JOIN EQUIPO ON EQC_EQUIP_id = EQUIP_id INNER JOIN LOGO ON EQC_LOGO_id = LOGO_id INNER JOIN MARCA ON EQC_MARCA_id = MARCA_id WHERE EQC_codTag = @EQC_codTag",
  addNewActivo:
    "INSERT INTO EQUIPO_COMPLETO(EQC_serie,EQC_placa,EQC_EQUIP_id,EQC_MARCA_id,EQC_MAP_ciudad,EQC_MAP_provincia,EQC_MAP_address,EQC_USU_ing,EQC_fecha_ing,EQC_codTag,EQC_LOGO_id,EQC_nombreCliente,EQC_identificacionCliente,EQC_direccionCliente,EQC_NegocioCliente,EQC_telefonoCliente,EQC_estadoEquipo,EQC_cambio,EQC_observacion,EQC_TI_id,EQC_USU_edit,EQC_fecha_edit,EQC_UBIC_id,EQC_provincia,EQC_cabezales) VALUES(@EQC_serie,@EQC_placa,@EQC_EQUIP_id,@EQC_MARCA_id,@EQC_MAP_ciudad,@EQC_MAP_provincia,@EQC_MAP_address,@EQC_USU_ing,GETDATE(),@EQC_codTag,@EQC_LOGO_id,@EQC_nombreCliente,@EQC_identificacionCliente,@EQC_direccionCliente,@EQC_NegocioCliente,@EQC_telefonoCliente,@EQC_estadoEquipo,@EQC_cambio,@EQC_observacion,@EQC_TI_id,@EQC_USU_edit,GETDATE(),@EQC_UBIC_id,@EQC_provincia,@EQC_cabezales)",
  deleteActivo: "DELETE FROM EQUIPO_COMPLETO WHERE EQC_id= @Id",
  getTotalActivos: "SELECT COUNT(*) FROM EQUIPO_COMPLETO",
  updateActivoById:
    "UPDATE EQUIPO_COMPLETO SET EQC_serie = @EQC_serie,EQC_placa = @EQC_placa,EQC_EQUIP_id = @EQC_EQUIP_id,EQC_MARCA_id = @EQC_MARCA_id,EQC_MAP_ciudad = @EQC_MAP_ciudad,EQC_MAP_provincia = @EQC_MAP_provincia,EQC_MAP_address = @EQC_MAP_address,EQC_USU_edit = @EQC_USU_edit,EQC_fecha_edit = GETDATE(),EQC_codTag = @EQC_codTag,EQC_LOGO_id = @EQC_LOGO_id,EQC_nombreCliente = @EQC_nombreCliente,EQC_identificacionCliente = @EQC_identificacionCliente,EQC_direccionCliente = @EQC_direccionCliente,EQC_NegocioCliente = @EQC_NegocioCliente,EQC_telefonoCliente = @EQC_telefonoCliente,EQC_cambio = @EQC_cambio,EQC_estadoEquipo = @EQC_estadoEquipo,EQC_observacion = @EQC_observacion, EQC_TI_id = @EQC_TI_id, EQC_UBIC_id = @EQC_UBIC_id,EQC_provincia = @EQC_provincia,EQC_cabezales =@EQC_cabezales  WHERE EQC_id = @Id",
  ...
  getTotalModelos: "SELECT T.MARCA_descripcion AS EQUIP_modelo,COUNT(DISTINCT(T.EQC_id))AS CONTEO FROM(SELECT EQC_MARCA_id,EQC_id,MARCA_descripcion FROM EQUIPO_COMPLETO INNER JOIN MARCA ON EQC_MARCA_id = MARCA_id)  T GROUP BY T.MARCA_descripcion ORDER BY CONTEO DESC",
