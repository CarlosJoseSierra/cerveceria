export const querys = {
  ...
  getTotalModelos: "SELECT T.MARCA_descripcion,COUNT(DISTINCT(T.EQC_id))AS CONTEO FROM(SELECT EQC_MARCA_id,EQC_id,MARCA_descripcion FROM EQUIPO_COMPLETO INNER JOIN MARCA ON EQC_MARCA_id = MARCA_id)  T GROUP BY T.MARCA_descripcion ORDER BY CONTEO DESC",
